...
class PredictView(views.APIView):
    def post(self, request, endpoint_name, format=None):
        ...
        # print(prediction["request_id"]) ==> check variable "request_id"
    ...
    def post(self, request, ab_test_id, format = None):
        ...
        try:
            ...
            if ab_test.ended_at is not None:
                return Response({"message": "AB Test is already finished"})
            ...
            correct_response_1 = MLRequest.objects.filter(parent_mlalgorithm=ab_test.parent_mlalgorithm_1,
                                                        created_at__gt = ab_test.created_at,
            ...
            correct_response_2 = MLRequest.objects.filter(parent_mlalgorithm=ab_test.parent_mlalgorithm_2,
                                                        created_at__gt = ab_test.created_at,
                                                        created_at__lt = date_now, 
                                                        response = F('feedback')).count()
