...
class Endpoint(models.Model):
    ...
    đây là điểm cuối của interface của app ml, 1 trong nhiều app mà django có thể bao gồm
    Attributes:
        name: the name of endpoints, it will be used in API URL
        ower: the string with owner name
